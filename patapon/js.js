...
function WIN()
{
    ...
    puh=JSON.parse(localStorage.field);
    setTimeout(`
    field.play=false;
    ...
    switch (+lol)
    {
        case 1:
            puh.coins+=50;
            document.getElementById(`win${+lol}`).style.height="1000px";
            document.getElementById(`win${+lol}`).style.width="1000px";
        break;
    ...
    localStorage.setItem("field",JSON.stringify(puh));
}
